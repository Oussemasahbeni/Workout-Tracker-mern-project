  ...
  return (
    <div className=" flex justify-center items-center  flex-col   ">
      <div className=" text-center  p-10 border-2 rounded-3xl bg-background bg-contain   ">
        ...
        <div class="mt-7 pt-9 mx-auto rounded-2xl lg:w-5/5">
          <img
            ...
            decoding="async"
            data-nimg="1"
            class="rounded-3xl border-2 border-white mx-auto object-cover bg-transparent "
            src="/landingPageImg.jpg"
          ></img>
        </div>
        <div class="w-full md:w-5/5 mx-auto text-center lg:pt-12 mt-6 bg-white border-5 rounded-3xl">
          <span class="badgeBoxShadow uppercase rounded-2xl text-[#6A65FF] text-sm md:text-base font-medium leading-loose  tracking-widest px-5 py-3 badgeGradientText text-transparent bg-clip-text">
            Features
          </span>
          <h1 class="text-4xl md:text-5xl lg:text-6xl mb-4 font-bold text-iso-gray-dark pt-3 mt-2">
            Explore Our Amazing
          </h1>
          ...
          <div class="pt-12 md:pt-24 mx-auto w-4/5  lg:grid lg:gap-8 lg:grid-cols-2">
            <div class=" pb-12 m-auto text-left">
              <h1 class="w-4/5 text-3xl md:text-4xl lg:text-3xl leading-tight pt-4 tracking-tight mb-4 font-semibold  text-iso-gray-dark">
                Create tasks and notes with ease
              </h1>
              <p class="mb-8 leading-relaxed font-normal mt-4 text-iso-gray text-lg w-4/5 ">
                With our workout app, you can quickly add loads and sets to help
                you plan and organize your workouts.
              </p>
              <ul class="font-normal text-iso-gray flex flex-col flex-wrap space-y-4 text-lg">
            ...
            <div class=" mx-auto rounded-3xl h-5/6 pt-8 mt-4">
              <img
                alt="hero"
                loading="lazy"
                width="500"
