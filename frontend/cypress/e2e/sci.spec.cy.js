...
describe("whole use cases", () => {
  it("should navigate to the signup page from the landing page", () => {
    ...
    cy.get("h3").should("contain", "Sign up to Your Account");
  });

  it("should display an error message when passwords do not match", () => {
    cy.visit("/signup");
    cy.get('[data-testid="username-input"]').type("testuser7");
    cy.get('[data-testid="email-input"]').type("testuser7@gmail.com");
    cy.get('[data-testid="password-input"]').type("TestTest123#");
    cy.get('[data-testid="confirm-password-input"]').type("TestTest123##", {
      force: true,
    });
    cy.get('[data-testid="signup-button"]').click({ force: true });
    cy.get('[data-testid="error"]').should("contain", "Passwords do not match");
  });
  ...
  it("should display an error message when the username already exists", () => {
    cy.visit("/signup");
    cy.get('[data-testid="username-input"]').type("spike");
    cy.get('[data-testid="email-input"]').type("newuser3@gmail.com");
    cy.get('[data-testid="password-input"]').type("TestTest123#");
    cy.get('[data-testid="confirm-password-input"]').type("TestTest123#", {
      force: true,
    });
  ...
  it("should display an error message when the email already exists", () => {
    ...
    cy.get('[data-testid="email-input"]').type("oussemasahbeni300@gmail.com");
    cy.get('[data-testid="password-input"]').type("TestTest123#");
    cy.get('[data-testid="confirm-password-input"]').type("TestTest123#", {
      force: true,
    });
  ...
  it("should sign up successfully with valid credentials", () => {
    ...
    cy.get('[data-testid="email-input"]').type("testuser4@gmail.com");
    cy.get('[data-testid="password-input"]').type("TestTest123#");
    cy.get('[data-testid="confirm-password-input"]').type("TestTest123#", {
      force: true,
    });
